from OLD.ImageTools import track_names, road_type_possibilities
from OLD.Utils.text_utils import contains_track_name, clean_race_data
from OLD.ImageTools.image_processing.extractor import run_extraction_with_options, preprocessing_options
import itertools
