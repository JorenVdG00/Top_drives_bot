from OLD.Database.methods.db_events import get_series, get_races, get_assignees
...
from OLD.Utils.file_utils import cleanup_dir

from OLD.ImageTools import get_only_race_tracks
from OLD.ImageTools import crop_in_game_event_types
