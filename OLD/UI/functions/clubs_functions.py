...
from OLD.UI.functions.general_functions import tap, swipe_and_hold, capture_screenshot, remove_screenshot
from OLD.UI.functions.event_functions import swipe_cars_to_slots, skip_ingame, check_accept_skip, tap_in_event_play, tap_events, \
    get_upgrade_after_match
from OLD.UI.functions.general_game_functions import tap_home, get_sort_toggle, tap_sort_asc, un_swipe_cars, tap_requirements_1, \
    tap_requirements_2, tap_requirements_tab, swipe_cars, get_missing_slots
from config import BOT_SCREENSHOTS_DIR, resize_values
from OLD.UI.functions.resize_functions import resize_coordinates, resize_ranges, resize_same_factor, \
    calculate_screen_size
from OLD.Utils.image_utils import color_almost_matches, resize_image, screenshot_context
from OLD.Utils.data_utils import find_differences
from OLD.ImageTools import get_club_pick_score
from OLD.ImageTools import weight_to_team
from OLD.ImageTools import crop_club_info, get_club_event_names, crop_in_event_club_info
from OLD.ImageTools import check_problem, get_car_with_repairs
from OLD.ImageTools import club_coordinates
from OLD.scraper.active_club_scraper import refresh_club_info
from OLD.Database.methods.db_events import get_req_id, get_track_set, get_club_from_name, get_req_list, get_played_matches, \
    play_club_event, get_club_track_set_of_name, get_req_num, end_active_club, get_active_club
from OLD.Database.methods.db_adder import add_club_event
import os
import time
import random
...
def check_play_button():
    from OLD.Utils.image_utils import color_distance
...
def full_clubs():
    ...
    while not club_ended:
        ...
        if can_play:
            ...
            with screenshot_context() as img:
                club_ended = check_club_rewards(img)
