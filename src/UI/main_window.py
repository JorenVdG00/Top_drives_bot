...
from src.UI.event_tab import EventTab
from src.Utils.Adb.adb_class import AdbClass
# from src.UI.car_assignment_tab_v2 import CarAssignmentTab
from src.UI.config_check import ConfigDialog
...
class MainWindow(QMainWindow):
    def __init__(self):
        super().__init__()
        self.bot = BotBase()
        self.adb = self.bot.adb
        self.worker = Worker(self.bot.adb)
        self.initUI()
