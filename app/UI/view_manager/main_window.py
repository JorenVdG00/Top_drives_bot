...
from app.UI.view_manager.terminal_tab import TerminalTab
...
# from test_garage_reader import get_cars_from_screen
...
class MainWindow(QMainWindow):
    ...
    def test_nav_title(self):
        self.log("get Nav title...")
        navTitle = get_nav_title()
        self.log("Nav title: " + str(navTitle))
