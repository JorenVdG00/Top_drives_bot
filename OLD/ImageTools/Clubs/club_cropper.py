...
from OLD.ImageTools.cropper.coords import club_coordinates, club_info_coords, in_event_club_info_coords
from OLD.ImageTools.Clubs.clean_clubs import fix_rq_value, cut_until_integer
...
from OLD.Database.methods.db_events import get_req_id
...
if __name__ == '__main__':
    img_path = '../../ZZZZpractice/tst/in_club_event_cropper.png'
