...
asc_path = img_dir + 'sort_asc.png'
desc_path = img_dir + 'sort_desc.png'
sort_path = img_dir + 'sort.png'
add_hand_path = img_dir + 'add_hand.png'
remove_hand_path = img_dir + 'remove_hand.png'

if __name__ == '__main__':
    get_all_coords(add_hand_path, new_size2, STANDARD_SCREEN_SIZE)
