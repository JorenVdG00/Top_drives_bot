...
from UI.functions.resize_functions import resize_coordinate, resize_coordinates, resize_ranges
from UI.functions.general_functions import capture_screenshot, remove_screenshot, tap, color_almost_same, swipe, swipe_and_hold
