...
from OLD.UI.functions.general_functions import capture_screenshot, tap, swipe, remove_screenshot
from OLD.UI.functions.resize_functions import calculate_screen_size, resize_ranges
from OLD.UI.functions.event_functions import tap_event, tap_events, tap_home, tap_play_event, \
...
from OLD.Database.methods.db_adder import add_event, add_race, add_track_set, add_track_serie
from OLD.Database.methods.db_delete import remove_event
from OLD.Database.db_getters import get_event_id_by_name

from OLD.ImageTools.cropper.cars import crop_all_hand_cars
from OLD.ImageTools.cropper.classify import get_event_name
from OLD.ImageTools.Events.event_cropper import crop_and_save_event_type_images
from OLD.ImageTools.Events.event_reader import get_full_correct_list
from OLD.ImageTools.Events.end_time import get_time_left_event, calculate_event_end_time
from OLD.Utils.file_utils import cleanup_dir, move_and_rename
