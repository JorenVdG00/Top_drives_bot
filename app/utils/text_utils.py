...
def score_match(extracted_text, expected_text):
    """
    Scores the match between the extracted text and the expected text.
    ...
    """
    return SequenceMatcher(None, extracted_text, expected_text).ratio()
...
def extract_integers(s):
    ...
    digit_strings = re.findall(r'\d', str(s))
    if digit_strings:
