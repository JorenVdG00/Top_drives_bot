...
import cv2
import numpy as np
# from image_enhancer import enhance_contrast, convert_to_grayscale, binarize_image, remove_noise, deskew_image
...
# Load the image
test_img_path = '../../ZZZZZ-TEST-IIIIIIIIMG/test_cropped_imgs/Cars(1,1).png'
